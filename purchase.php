...
?>
	<table class="table">
		...
		<tr>
			...
			<th>&nbsp;</th>
			<th>&nbsp;</th>
			<th><?php echo "₱" . ($_SESSION['total_price'] + 110); ?></th>
		</tr>
	</table>
	<form method="post" action="process.php" class="form-horizontal">
        ...
        <div class="form-group">
            <label for="card_PID" class="col-lg-2 control-label">Reference Number</label>
            <div class="col-lg-10">
        ...
        <div class="form-group">
            <label for="card_owner" class="col-lg-2 control-label">Fullname of Receipient</label>
            <div class="col-lg-10">
